...
<head>
    <title>Code coverage report for src/picoschema.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> picoschema.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">88.05% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>118/134</span>
            </div>
...
&nbsp;
  private async mustResolveSchema(schemaName: string): Promise&lt;JSONSchema&gt; {
    if (!this.schemaResolver) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >      throw new Error(`Picoschema: unsupported scalar type '${schemaName}'.`);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
&nbsp;
    const val = await this.schemaResolver(schemaName);
    if (!val) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >      throw new Error(</span>
<span class="cstat-no" title="statement not covered" >        `Picoschema: could not find schema with name '${schemaName}'`</span>
<span class="cstat-no" title="statement not covered" >      );</span>
<span class="cstat-no" title="statement not covered" >    }</span>
    return val;
  }
&nbsp;
  async parse(schema: unknown): Promise&lt;JSONSchema | null&gt; {
    if (!schema) <span class="branch-0 cbranch-no" title="branch not covered" >return null;</span>
&nbsp;
    ...
    if (typeof schema === 'string') {
      ...
      return description ? { ...resolvedSchema, description <span class="branch-0 cbranch-no" title="branch not covered" >} : resolvedSchema;</span>
    }
&nbsp;
...
&nbsp;
    ...
    } else if (typeof obj !== 'object') <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >      throw new Error(</span>
<span class="cstat-no" title="statement not covered" >        'Picoschema: only consists of objects and strings. Got: ' +</span>
<span class="cstat-no" title="statement not covered" >          JSON.stringify(obj)</span>
<span class="cstat-no" title="statement not covered" >      );</span>
<span class="cstat-no" title="statement not covered" >    }</span>
&nbsp;
...
&nbsp;
      ...
      if (type === 'array') {
        schema.properties[propertyName] = {
          type: <span class="branch-0 cbranch-no" title="branch not covered" >isOptional ? ['array', 'null'] : '</span>array',
...
<span class="cstat-no" title="statement not covered" >        throw new Error(</span>
<span class="cstat-no" title="statement not covered" >          "Picoschema: parenthetical types must be 'object' or 'array', got: " +</span>
